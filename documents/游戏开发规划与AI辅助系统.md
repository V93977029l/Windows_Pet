...
```
游戏项目根目录 (f:\VSCode\game)
├── documents/              # 项目文档（所有记录存放处
│   ├── 桌宠开发日志.md
│   ├── 项目结构总览.md
│   ├── 快速测试指南.md
│   ├── 游戏开发规划与AI辅助系统.md
│   └── resource_guide/  # 资源指南子目录
├── transparent-pet/    # ⭐ Godot主项目
│   ├── core/          # 核心系统
│   ├── modules/       # 功能模块（按功能组织）
│   ├── prototypes/   # 原型区
│   └── config/       # 配置
└── gdextension/       # GDExtension扩展
```
...
## 项目目标
- ~~在未来两个月内完成一个游戏项目~~ → **已完成桌宠项目v0.1.0版本**
- 准备在Steam平台发布
- 建立高效的创意管理和项目规划流程
- 利用AI辅助提高开发效率和决策质量
...
- **创意顾问**：协助创意的发展和筛选
- **全权秘书**：处理日常的信息管理和规划任务
- **模块化架构专家**：遵循 `.trae/rules/rule.md 中定义的商业级模块化架构规范
